...
export function activate(state: ViewerState, annotationId: number): ViewerState {
  return {
    ...state,
    activeAnnotationId:
...
export function setFunctionFilter(state: ViewerState, filter: FunctionFilter): ViewerState {
  return { ...state, functionFilter: filter };
}

export function setLevelFilter(state: ViewerState, filter: LevelFilter): ViewerState {
